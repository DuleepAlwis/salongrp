    ...
    <div class='container'>
      <div class='row'>
        ...
        <div id='report' class='col-md-2 menuBox' style='border-style: outset;background-color: #28a745'>
         <img src='../img/report1.png' width='35%' height='35%'><a href='ReceptionistReport1.php' style='font-size: 23px;color: #343a40 ' class='navbar-brand display-5'>S & R Report1</a>
        </div>
        ...
        <div class='collapse navbar-collapse text-white justify-content-end' id='navbarNav'>
            <ul class='navbar-nav'>
                ...
                <li class='nav-item active'>
                    ...
                    <a class='nav-link' href='ReceptionistReport1.php'><button class='btn btn-primary btn-hover'>Reports</button> </a>
                </li>
